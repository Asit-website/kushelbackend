...
import techApi1 from "./technologyApi/techApi1";
...
import techApi2 from "./technologyApi/techApi2";
import techApi3 from "./technologyApi/techApi3";
import techApi4 from "./technologyApi/techApi4";
...
const Home = ({ mode }) => {
  ...
  const setChange = (e) => {
    e.preventDefault();
    setGrad(1);
    document.getElementById("ask").style.background =
      "linear-gradient(to bottom, #F3670E, #F5B307) border-box";
    ...
    document.getElementById("bsk").style.borderImage =
      "linear-gradient(#29b12b, #33ead7) 1";
  };
  const setChange1 = (e) => {
    e.preventDefault();
    setGrad(2);
    document.getElementById("bsk").style.background =
      "linear-gradient(to bottom, #29B22D, #29B22D,#24D968) border-box";
    document.getElementById("bsk").style.borderImage = "none";
    document.getElementById("bsk").style.borderStyle = "none";
    document.getElementById("ask").style.borderImage =
      "linear-gradient(#FDCB2C, #F9863F) 1";
  ...
  const setChange2 = (e) => {
    e.preventDefault();
    setGrad(3);
    document.getElementById("csk").style.background =
      "linear-gradient(to bottom, #0B9A44, #0A7E12) border-box";
    ...
    document.getElementById("dsk").style.borderImage =
      "linear-gradient(#F752B0, #A400FF) 1";
  };

  const setChange3 = (e) => {
    e.preventDefault();
    setGrad(4);
    document.getElementById("dsk").style.background =
      "linear-gradient(to bottom, #BF00FF, #280334) border-box";
    ...
    document.getElementById("csk").style.borderImage =
      "linear-gradient(#29b12b, #33ead7) 1";
  };
  const setChange4 = (e) => {
    e.preventDefault();
    ...
    <>
      ...
      <div style={tiger} className="partner">
        ...
        <div className="second_partner">
          <div className="second_all">
            ...
            <NavLink to="/about">
              <button style={tiger2} className="who_btn">
                About us
              </button>
            </NavLink>
          </div>
      ...
      <div style={tiger1} className="services">
        ...
        <div className="heading-service">
          ...
          <h2 style={tiger2}>
            We employ quality design and development techniques as
          </h2>
          <h2 style={tiger2}>
            a foundation for the structured and systematic rapid
          </h2>
          <h2 style={tiger2}>
            ...
            <div className="section-service">
              <div className="second-service">
                <div
                  onClick={setChange2}
                  id="csk"
                  className="three-section-second"
                >
                  <img
                    style={filterCss}
                    className="second-im"
                    ...
                    alt=""
                  />
                  <p style={tiger2}>Digital Marketing</p>
                  <img
                    style={{
                      width: "20px",
                      margin: "0px -1px",
              ...
              <div className="fourth-service">
                <div
                  onClick={setChange3}
                  id="dsk"
                  className="three-section-fourth"
                >
                  <img
                    style={filterCss}
                    className="fourth-im"
            ...
            <>
              <div>
                <div className="service-content">
                  <p style={tiger2}>
                    With a decade-long experience in UI/UX designing, our
                    creative team of designers offers a full range of web and
                    mobile app design services, from prototyping and graphic
                    design to pixel-perfect UI.
                  </p>
                </div>
      ...
      <div style={techfast} className="technology">
        <img
          style={{ filter: mode === "dark" ? "invert(0)" : "invert(1)" }}
          src={tech}
          alt=""
        />
        <h3>
          Tools & Trending Technologies Our Software <br /> Developers Use
        </h3>
        <div className="trend-para">
          <p>
            Kusheldigi is evolving into an international contender in software
            engineering, <br /> with broad expertise in all areas required for
            credible software development.
          </p>
        </div>
        ...
        <div  style={savedCss} className="tech-image ">
          {techAnotherApi.map((val) => {
            const { id, Name, width } = val;
            return <img key={id} style={{ width: width }} src={Name} className="asit" alt="" />;
          })}
        </div>
    
        <button style={tiger2} onClick={setButton} className="button-chu">
          see More
        </button>
        <div className="tech-div">
          ...
          <h2 className="fontRelated" style={fontRelated}>
      ...
      <div style={latestPro} className="project">
        ...
        <NavLink to="#!">
          {" "}
          <button style={tiger2} className="project-btn">
            View Portfolio
          </button>
        </NavLink>
      </div>
      ...
      <div style={industrywise} className="industry">
        ...
        <div className="industry-system">
          <div className="small-fintech">
            <span style={filterCss} id="bar" onClick={menu1}>
              Fintech
            </span>
            <div className="fintech-para">
              <p style={filterCss} id="tam" onClick={menu2}>
                E-Commerce
              </p>
              <p style={filterCss} id="cam" onClick={menu3}>
                Healthcare
              </p>
              <p style={filterCss} id="dam" onClick={menu4}>
                Fitness
              </p>
              <p style={filterCss} id="eam" onClick={menu5}>
                Food Delivery
              </p>
              <p style={filterCss} id="fam" onClick={menu6}>
                Real Estate
              </p>
              <p style={filterCss} id="gam" onClick={menu7}>
                Travel
              </p>
              <p style={filterCss} id="ham" onClick={menu8}>
                Sports
              </p>
              <p style={filterCss} id="iam" onClick={menu9}>
                Social Networking
              </p>
              <p style={filterCss} id="jam" onClick={menu10}>
                Business
              </p>
              <p style={filterCss} id="kam" onClick={menu11}>
                Education
              </p>
              <p style={filterCss} id="lam" onClick={menu12}>
                Entertainment
              </p>
            </div>
          </div>
            ...
            <>
              <div className="big-fintech">
                ...
                <div className="big-fintch-para">
                  <p style={tiger2}>
                    Make your customers digital banking and investing{" "}
                  </p>
                  <p style={tiger2}>
              ...
              <div className="fin-portfolio">
                <button style={tiger2} className="fin-btn">
                  View Portfolio
                </button>
      ...
      <div style={businesswise} className="business">
        <h2 style={tiger2}>Our Business Models</h2>
        <div className="three-business">
          <p style={tiger2} id="barier" onClick={time} className="first-b">
            Time & Material
          </p>
          <p style={tiger2} id="camp" onClick={hired} className="second-p">
            Hire Team
          </p>
          <p style={tiger2} id="tamp" onClick={fix} className="third-p">
            Fix Scope Model
          </p>
        </div>
        {link === 1 && (
            ...
            <div className="pic-para">
              ...
              <div className="head-pa">
                ...
                <p style={tiger2}>
                  ...
                  dolore nobis deleniti nostrum? Iste maxime at omnis molestias
                  nulla cum eius temporibus rerum. Maxime omnis delectus
                  voluptatem repudiandae, itaque consequuntur.
                </p>
              </div>
            </div>
          </>
            ...
            <div className="pic-para">
              ...
              <div className="head-pa">
                ...
                <p style={tiger2}>
                  ...
                  Corrupti ad, impedit fugit similique dolor aperiam obcaecati,
                  deserunt veniam quam eum exercitationem at nihil dolorum?
                  Reiciendis neque quisquam eius in repellat
                </p>
              </div>
            </div>
          </>
      ...
      <div style={reviewCss} className="reviews">
        ...
        <h2 style={tiger2}>What do Kusheldigi's Partners Say?</h2>
        ...
        <div className="second-span">Our Valuable Clients</div>
        <div className="clients-para">
          <p>
            Over the past five years, the talented team at Kusheldigi has
            assisted both startup
          </p>
          <p>
            enterprises and well-known brands in laying a strong technological
            foundation for their <br /> operations
          </p>
        </div>
