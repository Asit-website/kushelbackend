      ...
      <div className="on-demand">
        ...
        <div className="two-div two-di">
          ...
          >
            ...
            <NavLink className="touchable" to="/service">
              <button>Explore All Services</button>
            </NavLink>
          </div>
          <div className="ano-color ano-col ano-col6">
            <div className="ano-group">
              <span>Want to hire a resource to </span>
              <span>work with you?</span>
            </div>
            <NavLink className="touchable" to="/hiring">
        ...
        <div className="busta sortinga">
          ...
          <div className="three-business">
            <p id="barier" onClick={time} className="first-b">
              Time & Material
            </p>
            <p id="camp" onClick={hired} className="second-p">
              Hire Team
            </p>
            <p id="tamp" onClick={fix} className="third-p">
              Fix Scope Model
            </p>
          </div>
            ...
            <>
              <div className="pic-para">
                ...
                <div className="head-pa">
                  <h2>Time & Material</h2>
                  <p>
                    We welcome the obscure vision through Time and Material
                    Model that supports the Agile Development Process. This is a
                    model where the client only pays for the time and resources
